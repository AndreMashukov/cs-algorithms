...
function cartesianProduct(setA, setB) {
  ...
  // Otherwise return null since
  // we can't generate Cartesian Product out of them.
  ...
  // Now, let's go through all elements of a first
  // and second set and form all possible pairs.
