 ...
 *
 * @property {function(vertices: Object)} [enterVertex] -
 * Called when DFS enters the vertex.
 *
 * @property {function(vertices: Object)} [leaveVertex] -
...
function initCallbacks(callbacks = {}) {
  ...
  initiatedCallback.enterVertex = callbacks.enterVertex ||
    stubCallback;
 ...
 * @param {Callbacks} callbacks
 */
function depthFirstSearchRecursive(graph, currentVertex,
    previousVertex, callbacks) {
