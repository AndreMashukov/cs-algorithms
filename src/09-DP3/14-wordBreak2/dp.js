...
console.log(
  `DP Result: [${wordBreak(s1, wordDict1)
    .map((s) => `"${s}"`)
    .join(', ')}]`
);
console.log(
  `Two-Pass Result: [${wordBreakTwoPass(s1, wordDict1)
    .map((s) => `"${s}"`)
    .join(', ')}]`
);
...
console.log(
  `DP Result: [${wordBreak(s2, wordDict2)
    .map((s) => `"${s}"`)
    .join(', ')}]`
);
...
console.log(
  `DP Result: [${wordBreak(s3, wordDict3)
    .map((s) => `"${s}"`)
    .join(', ')}]`
);
...
console.log(
  `DP Result: [${wordBreak(s4, wordDict4)
    .map((s) => `"${s}"`)
    .join(', ')}]`
);
