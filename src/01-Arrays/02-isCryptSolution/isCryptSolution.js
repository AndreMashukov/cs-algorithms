// A cryptarithm is a mathematical puzzle for which the goal is
// to find the correspondence between letters and digits,
...
// that follow the structure: [word1, word2, word3],
// which should be interpreted as the word1 + word2 = word3 cryptarithm.

// If crypt, when it is decoded by replacing
// all of the letters in the cryptarithm with digits using
// the mapping in solution, becomes a valid arithmetic equation
