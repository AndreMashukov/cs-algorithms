const { solution } = require('../../../src/misc/05-nov-2023/digit-anagram');

describe('misc.july2022.digit-anagram', () => {
  it('should return 4', () => {
    const result = solution([25, 35, 872, 228, 53, 278, 872]);
    expect(result).toEqual(4);
  });
});

// Given an array of integers a,
// your task is to count the number of pairs i and j
...
// In other words, one can be obtained from the other by rearranging
// the digits (or trivially, if the numbers are equal).

// For example, 54275 and 45572 are digit anagrams,
//     but 321 and 782 are not (since they don't contain
//     the same digits). 220 and 22 are also not considered as digit anagrams,
