...
const cp = require('../../src/sets/cartProd');

describe('cartesianProduct', () => {
  it('should return null if there is not enough info for calculation', () => {
    const product1 = cp.cartesianProduct([1], null);
    const product2 = cp.cartesianProduct([], null);
  ...
  it('should calculate the product of two sets', () => {
    const product1 = cp.cartesianProduct([1], [1]);
    const product2 = cp.cartesianProduct([1, 2], [3, 5]);
